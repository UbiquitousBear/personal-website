...
class Home extends Component {
	...
	constructor(props: { dependencies: { blogService: BlogServiceInterface }}) {
		super(props);
			...
			<LayoutGrid>
				<LayoutGrid.Inner>
					<LayoutGrid.Cell cols="12">
						<div><Typography headline4={true}>Hi, I'm Shamil.</Typography></div>
						<div><Typography headline5={true}>I'm a London-based developer, currently working as a Production Engineer.</Typography></div>
					</LayoutGrid.Cell>
				</LayoutGrid.Inner>
			</LayoutGrid>
		</div>
						...
						<div>
							<LayoutGrid>
								<LayoutGrid.Inner>
									...
									{ blogItems.map((blogItem: BlogItem, index: number) => (
										<LayoutGrid.Cell cols="12">
											<div>
												<Typography headline6={true}>
													<a href={ this.buildBlogUrl(blogItem) }>
														{ blogItem.title }
													</a>
												</Typography>
											</div>
											<div><Typography body2={true}>{ blogItem.summary }</Typography></div>
										</LayoutGrid.Cell>
									)) }
